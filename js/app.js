$(document).ready(function(){
    ...
    $('#search_trains').click(function (){
        ...
        $.ajax({
            url:"https://indianrailapi.com/api/v2/TrainBetweenStation/apikey/9bad3289d521930daa30e05c50c9e7c2/From/" + boarding_station + "/To/" + destination_station,
    ...
    $('#fetch_stations').click(function () {
        ...
        $.ajax({
            url:"https://indianrailapi.com/api/v2/TrainSchedule/apikey/9bad3289d521930daa30e05c50c9e7c2/TrainNumber/" + trainNo,
            success:function (data) {
                console.log(data);
